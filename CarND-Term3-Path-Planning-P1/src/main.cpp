          ...
          // j[1] is the data JSON object
			...
			for(int i = 0; i<sensor_fusion.size(); i++){
				...
				if(d<(2+4*lane +2) && (d>2+4*lane-2)){
					...
					check_car_s += (double)prev_size*0.02*check_speed; // Future position of car
...
//										}
			...
			// Fill up the remaining points for our path planner. Total 50 points
...
//                double next_d = 6; // One and half lane so 4*1.5
